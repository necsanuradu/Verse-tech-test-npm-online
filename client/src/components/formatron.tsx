...
const setInputInvalidFlag = (flag, key: string) => {
  let container = document.querySelector("form");
  if (container !== null) {
    const input = container.querySelectorAll(`[name="${key}"]`)[0];
    const checkDiv = input.nextElementSibling;
    flag && checkDiv !== null && checkDiv.tagName.toLowerCase() === "div"
...
const validateInput = (fieldState, name) => {
  ...
  setInputInvalidFlag(error, name);
